...
The submodules are the steps it is made of -- `digest`, `ligation`, `bench` and `steps`.
...
and the reactions built from them, and `steps` the protocol's own steps and their order. What
