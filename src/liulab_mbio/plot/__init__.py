...
the shapes and writes them; `page` wraps the SVG in one offline HTML page. A drawing is laid out
as geometry before anything draws, per `docs/adr/0006-drawings-as-geometry.md`.
